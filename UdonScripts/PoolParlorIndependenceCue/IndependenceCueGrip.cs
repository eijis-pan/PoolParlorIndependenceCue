...
public class IndependenceCueGrip : UdonSharpBehaviour
{
    private IndependenceCueController controller;
    ...
    public void _Init(IndependenceCueController controller_, bool _isSecondary)
    {
